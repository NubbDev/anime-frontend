<script lang="ts">
  ...
  import type { SVGAttributes } from 'svelte/elements';
    ...
    let navOptions: { name: string, href: string, selected: ComponentType<SvelteComponent<SVGAttributes<SVGSVGElement>, any, any>>, unSelected: ComponentType<SvelteComponent<SVGAttributes<SVGSVGElement>, any, any>> }[] = [
        {
            name: 'Home',
            href: '/',
    ...
    {#each navOptions as option}
        <a href={option.href}>
            {#if path === option.href} 
                ...
                {:else}
                    <svelte:component this={option.unSelected} fill="white" />
